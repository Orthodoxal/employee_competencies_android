...
import `is`.ulstu.myapplication.employees.domain.use_cases.DownloadCatalogUseCase
import `is`.ulstu.myapplication.employees.domain.use_cases.FindEmployeeByNameUseCase
import `is`.ulstu.myapplication.employees.domain.use_cases.GetCatalogUseCase
...
class EmployeesViewModel @Inject constructor(
    ...
    fun onEmployeeItemClick(employee: EmployeeModel) {
        // navigator ...
    }
