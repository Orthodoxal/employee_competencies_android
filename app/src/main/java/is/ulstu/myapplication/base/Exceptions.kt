package `is`.ulstu.myapplication.base

import `is`.ulstu.myapplication.base.api.ErrorResponseBody

open class AppException(override val message: String, cause: Throwable? = null) : Exception(message, cause)
